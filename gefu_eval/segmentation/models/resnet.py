...
model_urls = {
    ...
    'w_resnet18': 'https://gitlab.tudelft.nl/attilalengyel/ciconv/-/raw/master/model_zoo/w_resnet18.pth',
    'w_resnet101': 'https://gitlab.tudelft.nl/attilalengyel/ciconv/-/raw/master/model_zoo/w_resnet101.pth'
}

class ResNet(nn.Module):
    def __init__(self, block, layers, invariant=None, num_classes=1000, zero_init_residual=False,
                 groups=1, width_per_group=64, replace_stride_with_dilation=None,
                 norm_layer=None, k=3, scale=0.0, return_features=False, return_last_feature=False):
